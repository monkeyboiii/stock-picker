...
if __name__ == "__main__":
    ...
    assert egf.calculate_cost(**buy_args) == Decimal("10_0027")
    assert egf.calculate_cost(**sell_args) == Decimal("9_9923")

    logger.info(f"shanghai adjusted price {egf.adjust_price(**buy_args)}")
    logger.info(f"shanghai adjusted price {egf.adjust_price(**sell_args)}")
