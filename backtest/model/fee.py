...
class FeeBase(BaseModel, ABC):
    ...
    @abstractmethod
    def calculate_cost(self, price: Decimal, amount: Decimal) -> Decimal:
        pass

    @abstractmethod
    def adjust_price(self, price: Decimal, amount: Decimal) -> Decimal:
        pass
...
class CryptoFee(FeeBase):
    ...
    def adjust_cost(self, price: Decimal, amount: Decimal):
        raise NotImplementedError

    def adjust_price(self, price: Decimal, amount: Decimal):
        raise NotImplementedError
